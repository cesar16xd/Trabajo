...
<head>
  ...
  <link rel="stylesheet" type="text/css" href="public/css/Customer_Profile_Styles.css">
    ...
    <div class="row">
      ...
      <div class="col-sm-3 left">
        <div class="picture_profile">
          <img src="public/img/image_perfil.png" alt="Foto_de_perfil">
        </div>
        <p class="name-user">Cesar Wilder</p>
        <div class="close_session" align="center">Cerrar sesion</div>
        <div class="option_pane">
          <a href="home" class="Mi_Perfil"><b>Mi Perfil</b></a>
          <a href="#" class="Contratos">Contratos</a>
          <a href="#" class="Tecnicos">Tecnicos</a>
        </div>
      </div>

      <!--------- PANEL DERECHO ----------->
      <div class="col-sm-9 right">
        <div class="title">Mi Perfil de Tecnico</div>
        ...
        <div class="client_data container">
          <div class="row">
            ...
            <div class="col-sm-6">
              ...
              <p><b style="color:black">Celular : </b>cesarwilder@upn.pe</p>
            </div>
          </div>
        </div>
        <div class="buttons">
